...
public class RideBookingRequest {
    ...
    @Schema(description = "Pickup location", example = "123 Main Street, Cityville", required = true)
    private String pickup;

    @Schema(description = "Drop-off location", example = "456 Park Avenue, Townsville", required = true)
    private String drop;

    @Schema(description = "Indicates whether the ride includes a parcel", example = "false")
    private boolean isParcel;

    @Schema(description = "Current status of the ride", example = "REQUESTED")
